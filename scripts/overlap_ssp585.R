#####niche inferences in the ssp585###
...
varclim1 <- stack(list.files("C:/Niche_overlap/Data/regional_bioclimate_future/ssp585/", pattern=".tif", full.names=T))
...
a.dyn4<-ecospat.niche.equivalency.test(z1=z2_grid , z2=z1_grid, rep=1000)
ecospat.plot.overlap.test(a.dyn,"D","Equivalency")
ecospat.plot.overlap.test(a.dyn,"I","Equivalency")
