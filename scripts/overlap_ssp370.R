#####niche inferences in the ssp370###
...
varclim1 <- stack(list.files("C:/Niche_overlap/Data/regional_bioclimate_future/ssp370/", pattern=".tif", full.names=T))
